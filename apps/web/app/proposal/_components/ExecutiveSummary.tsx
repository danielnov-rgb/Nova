...
import { executiveSummary } from "../_data/proposal-content";
    ...
    <section className="py-24 px-4">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {executiveSummary.keyFacts.map((fact, index) => (
            <AnimatedSection key={fact.label} delay={index * 100}>
              <div className="group relative bg-gray-900/50 border border-gray-800 rounded-xl p-6 hover:border-gray-700 transition-all">
                ...
                <div className="relative">
                  ...
                  <div className="text-sm text-gray-400 mt-1">{fact.detail}</div>
